    ...
    for folder in os.listdir(img_dir):
        ...
        for img_path in os.listdir(current_folder):
            if os.path.splitext(img_path)[-1] in [".png", ".jpeg", ".jpg"]:
                ...
                image = Image.open(os.path.join(current_folder, img_path)).convert("RGB")
...
annotate_inaturalist_images(
    "../../../Downloads/inaturalist/inaturalist_crawler_data_all_cleaned_sub/",
    "../../../Downloads/inaturalist/inaturalist_crawler_data_all_cleaned_sub/inaturalist.csv"
)
